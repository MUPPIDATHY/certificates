...
exports.get_report = function (req, res) {
   ...
   if (req.method == "POST") {
      ...
      var bon_purpose ='';
      var bon_purpose_select=post.bon_purpose;

      var bon_pur_others= post.bon_pur_others;
      
      if(bon_purpose_select=='Others'){
         bon_purpose=bon_pur_others;
         bon_purpose = post.bon_pur_others;
      }
      else{

         bon_purpose=bon_purpose_select;
         bon_purpose = post.bon_purpose;
      }
    
console.log('bon_purpose',bon_purpose);
...
var sql12 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "' AND `category`='" + Photo + "'";
db.query(sql12, function (err, data12) {
      var sql1 = "SELECT *, DATE_FORMAT(course_commencement, '%d %M %Y') course_commencement, DATE_FORMAT(date_of_admission, '%d/%m/%Y') date_of_admission  FROM `ems`.`cand_admission_details` WHERE `cand_id`='" + cand_id + "'";
      db.query(sql1, function (err, data1) {
         ...
         db.query(sql, function (err, data) {
            res.render('report5.ejs', { message: message, userData: data, userData1: data1, userData12: data12,bon_ref_no:bon_ref_no,bon_acad_year:bon_acad_year,bon_purse:bon_purse,bon_stud_year:bon_stud_year,bon_purpose:bon_purpose,today:today});
         });
      });
      });
...
exports.get_report3 = function (req, res) {
   message = '';
   if (req.method == "POST") {
      var post = req.body;
      var cand_id=post.cand_id;
      ...
      var sql15 = "INSERT INTO `ems`.`ack_report`(`cand_id`,`ack_date`,`date`) VALUES ('" + cand_id + "','" + ack_date + "','"  + today + "')";
      var query = db.query(sql15, function (err, result) {

         var sql13 = "SELECT `cand_id` ,DATE_FORMAT(ack_date, '%d- %m-%Y') ack_date FROM `ems`.`ack_report` WHERE `cand_id`='" + cand_id + "' AND `date`='" + today + "'";
         db.query(sql13, function (err, data13) {
var sql12 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "' AND `category`='" + Photo + "'";
db.query(sql12, function (err, data12) {
   ...
   var sql1 = "SELECT *, DATE_FORMAT(course_commencement, '%d %M %Y') course_commencement, DATE_FORMAT(date_of_admission, '%d/%m/%Y') date_of_admission  FROM `ems`.`cand_admission_details` WHERE `cand_id`='" + cand_id + "'";
      db.query(sql1, function (err, data1) {
         var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
         db.query(sql, function (err, data) {
            res.render('report3.ejs', { message: message, userData: data, userData1: data1, userData2: data2,userData12: data12, userData13: data13});
         });
      });
   });
      });
...
exports.get_report9 = function (req, res) {
   message = '';
   if (req.method == "POST") {
      var post = req.body;
      var cand_id=post.cand_id;
   ...
   var objDate=new Date(today).toLocaleString('en-us',{month:'long'})+','+yyyy;
...
db.query(sql12, function (err, data12) {
   ...
   var sql1 = "SELECT *, DATE_FORMAT(course_commencement, '%d %M %Y') course_commencement, DATE_FORMAT(date_of_admission, '%d/%m/%Y') date_of_admission  FROM `ems`.`cand_admission_details` WHERE `cand_id`='" + cand_id + "'";
      db.query(sql1, function (err, data1) {
         var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
         db.query(sql, function (err, data) {
            res.render('report9.ejs', { message: message, userData: data, userData1: data1, userData2: data2,userData12: data12,cond_csp:cond_csp,cond_cep:cond_cep,cond_mbbs:cond_mbbs,cond_tsp:cond_tsp,cond_tep:cond_tep, objDate: objDate});
...
exports.get_report11 = function (req, res) {
   message = '';
   if (req.method == "POST") {
      var post = req.body;
      var cand_id=post.cand_id;
     ...
     var tc_high=post.tc_high;
      var sql15 = "INSERT INTO `ems`.`tc_report`(`cand_id`,`tc_reldate`,`tc_reas`,`tc_mark`,`tc_high`,`date`) VALUES ('" + cand_id + "','" + tc_reldate + "','" + tc_reas + "','" + tc_mark + "','" + tc_high + "','" + today + "')";
      var query = db.query(sql15, function (err, result) {

      var sql13 = "SELECT *,DATE_FORMAT(date, '%d- %m-%Y') date  FROM `ems`.`tc_report` WHERE `cand_id`='" + cand_id + "' AND `date`='" + today + "'";
      db.query(sql13, function (err, data13) {
var sql12 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "' AND `category`='" + Photo + "'";
db.query(sql12, function (err, data12) {
      var sql1 = "SELECT *, DATE_FORMAT(course_commencement, '%d %M %Y') course_commencement, DATE_FORMAT(date_of_admission, '%d/%m/%Y') date_of_admission  FROM `ems`.`cand_admission_details` WHERE `cand_id`='" + cand_id + "'";
      db.query(sql1, function (err, data1) {
         var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
         db.query(sql, function (err, data) {
            res.render('report11.ejs', { message: message, userData: data, userData1: data1, userData12: data12, userData13: data13});
         });
      });
      });
   });
...
exports.add_candidate = function (req, res) {
   ...
   if (req.method == "POST") {
      ...
      var dt = new Date();
      registered_time = `${(dt.getDate() + 1).toString().padStart(2, '0')}/${dt.getMonth().toString().padStart(2, '0')}/${dt.getFullYear().toString().padStart(4, '0')} ${dt.getHours().toString().padStart(2, '0')}:${dt.getMinutes().toString().padStart(2, '0')}:${dt.getSeconds().toString().padStart(2, '0')}`;
      last_modified_time = `${(dt.getDate() + 1).toString().padStart(2, '0')}/${dt.getmo().toString().padStart(2, '0')}/${dt.getFullYear().toString().padStart(4, '0')} ${dt.getHours().toString().padStart(2, '0')}:${dt.getMinutes().toString().padStart(2, '0')}:${dt.getSeconds().toString().padStart(2, '0')}`;
...
exports.add_user = function (req, res) {
   ...
   if (req.method == "POST") {
      ...
      var salt = 'yes';
      var dt = new Date();
      created_time = `${(dt.getDate() + 1).toString().padStart(2, '0')}/${dt.getMonth().toString().padStart(2, '0')}/${dt.getFullYear().toString().padStart(4, '0')} ${dt.getHours().toString().padStart(2, '0')}:${dt.getMinutes().toString().padStart(2, '0')}:${dt.getSeconds().toString().padStart(2, '0')}`;
      last_modified_time = `${(dt.getDate() + 1).toString().padStart(2, '0')}/${dt.getMonth().toString().padStart(2, '0')}/${dt.getFullYear().toString().padStart(4, '0')} ${dt.getHours().toString().padStart(2, '0')}:${dt.getMinutes().toString().padStart(2, '0')}:${dt.getSeconds().toString().padStart(2, '0')}`;
...
exports.reli_check = function (req, res, next) {
   ...
   if(reli_info=='All')
   {
      ...
      db.query(sql, function (err, data1) {
         ...
         db.query(sql, function (err, data) {
            res.render('reli_page.ejs', { userData: data, userData1: data1, userData3: data3, userData4: data4, userData5: data5,userData6: data6, userData7: data7,userData8: data8, userData10: data10,message: message });
         });
      });
   });
});
...
var sql12 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "' AND `category`='" + Photo + "'";
db.query(sql12, function (err, data12) {
      var sql13 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "' AND `category`='" + Sign + "'";

      // var sql13 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id +  "' AND `category`='" + Sign + "'";
      db.query(sql13, function (err, data13) {
         console.log("data13",data13);
         var sql14 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "' AND `category`='" + Thumb + "'";
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report1.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                  ...
                  db.query(sql5, function (err, data5) {
                     ...
                     db.query(sql4, function (err, data4) {
                        ...
                        db.query(sql3, function (err, data3) {
                           var sql2 = "SELECT * FROM `ems`.`cand_address_details` WHERE `cand_id`='" + cand_id + "'";
                           db.query(sql2, function (err, data2) {
                              var sql1 = "SELECT *, DATE_FORMAT(course_commencement, '%d %b %Y') course_commencement, DATE_FORMAT(date_of_admission, '%d-%m-%Y') date_of_admission  FROM `ems`.`cand_admission_details` WHERE `cand_id`='" + cand_id + "'";
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d-%m-%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report4.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report5.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report6.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d-%m-%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report7.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report8.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report9.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report10.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report11.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report12.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report13.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report14.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
...
exports.report15 = function (req, res, next) {
   var post = req.body;
   var message = "";
   var cand_id=post.cand_id;
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT *, DATE_FORMAT(date_of_birth, '%d/%m/%Y') date_of_birth FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('report15.ejs', { objDate:objDate,today:today,message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData12: data12,userData13: data13,userData14: data14 });
                                 });
                              });
                           });
                        });
...
exports.mbbs_viewcand = function (req, res) {
   ...
   var post = req.body;
   var cand_id = post.cand_id;
   var sql12 = "SELECT * FROM `ems`.`biometric_details` WHERE `cand_id`='" + cand_id + "'";
   db.query(sql12, function (err, data12) {
   var sql11 = "SELECT * FROM `ems`.`cand_relieving_details` WHERE `cand_id`='" + cand_id + "'";
   db.query(sql11, function (err, data11) {
   var sql10 = "SELECT * FROM `ems`.`cand_certificate2_details` WHERE `cand_id`='" + cand_id + "'";
                        ...
                        db.query(sql3, function (err, data3) {
                           ...
                           db.query(sql2, function (err, data2) {
                              ...
                              db.query(sql1, function (err, data1) {
                                 var sql = "SELECT * FROM `ems`.`cand_profile_details` WHERE `cand_id`='" + cand_id + "'";
                                 db.query(sql, function (err, data) {
                                    res.render('mbbs_viewcand.ejs', { message: message, userData: data, userData1: data1, userData2: data2, userData3: data3, userData4: data4, userData5: data5, userData6: data6, userData7: data7, userData8: data8, userData9: data9, userData10: data10, userData11: data11, userData12: data12 });
                                 });
                              });
                              });
                           });
