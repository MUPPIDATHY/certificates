...
app.post('/add_candidate', upload.any(), function (req, res, next) {
 ...
 //for biometric details & certificate details
...
app.get('/report11', user.report11);
app.post('/report11', user.report11);
app.get('/report12', user.report12);
app.post('/report12', user.report12);
app.get('/report13', user.report13);
app.post('/report13', user.report13);
app.get('/report14', user.report14);
app.post('/report14', user.report14);
app.get('/report15', user.report15);
app.post('/report15', user.report15);
app.get('/view_report', user.view_report);
app.post('/view_report', user.view_report);
app.get('/get_report', user.get_report);
app.post('/get_report', user.get_report);
app.get('/get_report3', user.get_report3);
app.post('/get_report3', user.get_report3);
app.get('/get_report9', user.get_report9);
app.post('/get_report9', user.get_report9);
app.get('/get_report11', user.get_report11);
app.post('/get_report11', user.get_report11);
